...
The data was sourced from the UCI Machine Learning Repository [@data-source]. It contains data about $178$ wines from Italy derived from three different cultivars. Each row represents the chemical and physical properties of a different wine, such as its concentration of alcohol, magnesium level and hue. 
...
Using this dataset, our predictive question is: "Can the cultivar a wine is derived from be reliably determined through physiochemical properties?"
