...
summary-stats-tables <- read_csv("../results/summary_stats.csv")
knitr::kable(summary-stats-tables)
```

In @tbl-summary-stats, we see that... !!!

![Scatterplot for !!!](../results/scatterplot.png){#fig-scatterplot width=90%}

We can see from @fig-scatterplot ... !!!

![Boxplotplot for !!!](../results/boxplot.png){#fig-boxplot width=90%}

We can see from @fig-boxplot ... !!!
...
## Discussion
![Accuracy plot for !!!](../results/accuracy_plot.png){#fig-accuracy-plot width=90%}

We can see from @fig-accuracy-plot ... !!!

```{r}
#| label: tbl-metrics
#| tbl-cap: Model Evaluation metrics.

metrics-tables <- read_csv("../results/metrics.csv")
knitr::kable(metrics-tables)
```
In @tbl-summary-stats, we see that... !!!
