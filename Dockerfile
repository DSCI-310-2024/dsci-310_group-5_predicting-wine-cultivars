...
RUN R -e "install.packages('tidyverse', repos=NULL, dependencies=TRUE, version='2.0.0')"
RUN R -e "install.packages('tidymodels', repos=NULL, dependencies=TRUE, version='1.1.1')"
RUN R -e "install.packages('kknn', repos=NULL, dependencies=TRUE, version='1.3.1')"
RUN R -e "install.packages('dplyr', repos=NULL, dependencies=TRUE, version='1.1.4')"
RUN R -e "install.packages('knitr', repos=NULL, dependencies=TRUE, version='1.45')"
